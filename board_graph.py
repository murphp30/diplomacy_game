...
province_borders = [
    ...
    ("Edi", "Nth"),
    ("Edi", "Yor"),
    ("Edi", "Lvp", {"land_only": True}),
    ("Lvp", "Iri"),
    ("Lvp", "NAt"),
    ("Lvp", "Yor", {"land_only": True}),
    ("Lvp", "Wal"),
    ("Lon", "Eng"),
    ("Lon", "Wal"),
    ("Lon", "Yor"),
    ...
    ("Nap", "Ion"),
    ("Pie", "GoL"),
    ("Pie", "Ven", {"land_only": True}),
    ("Pie", "Tus"),
    ("Rom", "Tyn"),
    ("Rom", "Tus"),
    ("Rom", "Ven", {"land_only": True}),
    ("Tus", "Tyn"),
    ("Tus", "GoL"),
    ("Tus", "Ven", {"land_only": True}),
    ("Ven", "Adr"),
    ("Lvn", "Bal"),
    ("Lvn", "Bot"),
    ("Lvn", "StP", {"coast": "south"}),
